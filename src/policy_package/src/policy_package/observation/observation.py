...
import policy_package.observation.observation_backend as bc
...
class ObservationType(StrEnum):
    ...
    FULL_OBSERVATION_WITH_VICON_FLAG = "full_observation_with_vicon_flag"
    FULL_STATE_OBSERVATION = "full_state_observation"
@bc.dataclass
...
@bc.dataclass(eq=False)
class FullObservationWithViconFlag(Observation):
    """Current observation of the drone environment."""
    drone_position: Vec3
    drone_orientation: Quat
    drone_velocity: Vec3
    ...
    previous_action: Vec4
@bc.dataclass(eq=False)
class FullStateObservation(Observation):
    """Current observation of the drone environment."""
    drone_position: Vec3
    drone_orientation: Quat
    drone_velocity: Vec3
