...
import psutil
from traj_policy_pkg.mlp_ctrl import MLPPilot
import rospy
import subprocess
import signal, sys
...
def main():    
    ...
    policy_name = str(rospy.get_param("~policy_name", ""))
    ...
    pilot = MLPPilot(
        ...
        traj_policy_name=policy_name,
    )
    
    child_processes.append(pilot.traj_policy.inference_server.server)
