...
tmux send-keys -t $SESSION:0.3 "roslaunch policy_package policy_node.launch policy_dir_name:=hover_policy drone_only:=true quad_name:=volley_drone" # Adjust quad_name as needed
